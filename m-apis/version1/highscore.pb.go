...
// versions:
// 	protoc-gen-go version1.25.0-devel
// 	protoc        v3.12.4
...
var file_highscore_proto_goTypes = []interface{}{
	(*SetHighScoreRequest)(nil),  // 0: m.highscore.version1.SetHighScoreRequest
	(*SetHighScoreResponse)(nil), // 1: m.highscore.version1.SetHighScoreResponse
	(*GetHighScoreRequest)(nil),  // 2: m.highscore.version1.GetHighScoreRequest
	(*GetHighScoreResponse)(nil), // 3: m.highscore.version1.GetHighScoreResponse
}
var file_highscore_proto_depIdxs = []int32{
	0, // 0: m.highscore.version1.Game.SetHighScore:input_type -> m.highscore.version1.SetHighScoreRequest
	2, // 1: m.highscore.version1.Game.GetHighScore:input_type -> m.highscore.version1.GetHighScoreRequest
	1, // 2: m.highscore.version1.Game.SetHighScore:output_type -> m.highscore.version1.SetHighScoreResponse
	3, // 3: m.highscore.version1.Game.GetHighScore:output_type -> m.highscore.version1.GetHighScoreResponse
...
func (c *gameClient) SetHighScore(ctx context.Context, in *SetHighScoreRequest, opts ...grpc.CallOption) (*SetHighScoreResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/m.highscore.version1.Game/SetHighScore", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameClient) GetHighScore(ctx context.Context, in *GetHighScoreRequest, opts ...grpc.CallOption) (*GetHighScoreResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/m.highscore.version1.Game/GetHighScore", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Game_SetHighScore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/m.highscore.version1.Game/SetHighScore",
	}
...
func _Game_GetHighScore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/m.highscore.version1.Game/GetHighScore",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Game_serviceDesc = grpc.ServiceDesc{
	ServiceName: "m.highscore.version1.Game",
